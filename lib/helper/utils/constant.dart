...
class Constant {
  ...
  static String packageName = "com.customer.greenfield";
  ...
  static String appStoreId = "com.customer.greenfield";

  static String deepLinkPrefix = "https://greenfeild.page.link";

  static String notificationChannel = "My Notifications";

  static String deepLinkName = "Greenfield Naturals";
  ...
  //google api keys
  static String googleApiKey = "AIzaSyBu6MyZUBhWEMu7y8No-cN7c9LMyBQIHDQ";

  //Set here 0 if you want to show all categories at home
  static int homeCategoryMaxLength = 20;
